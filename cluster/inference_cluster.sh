...
python inference_single_map.py --policy /cluster/project/rsl/alesweber/TerraProject/terra-baselines/checkpoints/mixed-agents-skidsteer-skidsteer-local-2026-07-20-15-11-52.pkl --config solo_excavator_rectangles --map_name map_13
#--use-mcts
