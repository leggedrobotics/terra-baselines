...
BANK_ARCHIVE=/home/lorenzo/moleworks/.artifacts/terra_v8_trench_finite_enriched_20260819/terra_v8_trench_pilot_pooled_bank_20260819.tar.zst
BANK_ARCHIVE_SHA=e88370a5314bad189e75dbacd706cd12d08d9d5f920d6c877bbace7aca55d48c
BANK_MAPS_PATH=train_pilot_pooled_12cond
BANK_DATASET_SIZE=1152
...
TRENCH_TERRA_REVISION_PIN=a4b838b6cb894fdf982b614d4deea96f778fd7b0
SEED=20260818
...
CAMPAIGN=terra_trench_align_v1
...
grep -q "path: &trench_align_bank $BANK_MAPS_PATH\$" \
...
for ARM in c0 t1; do
    RUN_NAME="trench_align_${ARM}_${BASELINES_REVISION:0:12}_s${SEED}"
    ...
    JOB_RAW="$(remote "cat '$REMOTE_SOURCE/scripts/euler_trench_align_v1/run.sbatch' | sbatch --parsable --account='es_hutter' --partition='$PARTITION' --time='$WALLTIME' --gpus='rtx_4090:4' --cpus-per-task='8' --exclude='eu-g6-064' --job-name='terra-trench-align-$ARM' --output='$RUN_DIR/slurm_%j.out' --export='$EXPORTS'")"
    JOB_ID="${JOB_RAW%%;*}"
    [[ "$JOB_ID" =~ ^[0-9]+$ ]]
