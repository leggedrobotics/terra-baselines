...
TEACHER_RUN_CONTRACT=/cluster/scratch/lterenzi/codex_terra_edge_runs/terra_v8_direct_full_teacher_v1/885b1dbe6d7ac4b4199140a188d147657760eeee/screen/s20260730/G-DEEP-XATTN-V8-DIRECT-FULL-TEACHER/run_contract.env
TEACHER_RUN_CONTRACT_SHA=5ebb4de9769d2222839d9845b8eb753d3275fb9b5bab9772d5030470926456fc
TEACHER_FIXED_EVAL_ROOT=/cluster/scratch/lterenzi/codex_terra_edge_runs/terra_v8_10m_curriculum_v1/548253810319831ce6102bea7cd315bff508ba94/reference_teacher_full_v8/s20260730
TEACHER_FIXED_EVAL_STATUS_SHA=dd46643b9ef4493330eb4997ebe7ff32083da46483fa1ea7e0ca9b6bb94fbbfa
TEACHER_FIXED_EVAL_MAIN_PROMOTION_SHA=7d7129595f0fa33d5fb1bb2f32a0e2a2f0ebcada2e09b933c346e81d1c9e4459
TEACHER_FIXED_EVAL_MAIN_DEVELOPMENT_SHA=6c4886822509e8f17f34f4d3904289c878cfc71d08061abc0084d8056f6f7f67
TEACHER_FIXED_EVAL_CAPABILITY_PROMOTION_SHA=e8f9cfaf31d085ee4e5378f42e9c838391144456c62692b8ec3b22a68872107e
TEACHER_FIXED_EVAL_CAPABILITY_DEVELOPMENT_SHA=6e0654f70b9d9b7d142e5c0603c3ad92fc4140b0379b934e748a9aec069fa89f
...
echo "teacher_update=7500 teacher_sha256=$TEACHER_SHA"
echo "teacher_fixed_eval_root=$TEACHER_FIXED_EVAL_ROOT"
for ARM in "${ARMS[@]}"; do
...
for ARM in "${ARMS[@]}"; do
    ...
    EXPORTS="ALL,PHASE=$PHASE,ARM=$ARM,BASELINES_ROOT=$REMOTE_SOURCE,BASELINES_REVISION=$BASELINES_REVISION,SEED=$SEED,BANK_ARCHIVE=$REMOTE_BANK,BANK_SHA=$BANK_SHA,BANK_DATASET_SHA=$BANK_DATASET_SHA,BANK_RELEASE_ID=$RELEASE_ID,PARENT_CHECKPOINT=${PARENTS[$ARM]},PARENT_SHA=${PARENT_SHAS[$ARM]},PARENT_SELECTION=$REMOTE_SELECTION,PARENT_SELECTION_SHA=$SELECTION_SHA,TEACHER_CHECKPOINT=$TEACHER_CHECKPOINT,TEACHER_SHA=$TEACHER_SHA,TEACHER_RUN_CONTRACT=$TEACHER_RUN_CONTRACT,TEACHER_RUN_CONTRACT_SHA=$TEACHER_RUN_CONTRACT_SHA,TEACHER_FIXED_EVAL_ROOT=$TEACHER_FIXED_EVAL_ROOT,TEACHER_FIXED_EVAL_STATUS_SHA=$TEACHER_FIXED_EVAL_STATUS_SHA,TEACHER_FIXED_EVAL_MAIN_PROMOTION_SHA=$TEACHER_FIXED_EVAL_MAIN_PROMOTION_SHA,TEACHER_FIXED_EVAL_MAIN_DEVELOPMENT_SHA=$TEACHER_FIXED_EVAL_MAIN_DEVELOPMENT_SHA,TEACHER_FIXED_EVAL_CAPABILITY_PROMOTION_SHA=$TEACHER_FIXED_EVAL_CAPABILITY_PROMOTION_SHA,TEACHER_FIXED_EVAL_CAPABILITY_DEVELOPMENT_SHA=$TEACHER_FIXED_EVAL_CAPABILITY_DEVELOPMENT_SHA,SMOKE_JOB_ID=$SMOKE_JOB_ID,SMOKE_RUN=$SMOKE_RUN"
    JOB_ID="$(
