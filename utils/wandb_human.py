...
TRAINING_SCALAR_KEYS = frozenset(
    {
        ...
        *{f"behavior/action_fraction/{name}" for name in ACTION_NAMES},
        ...
        "reward/behavior_cost_ramp_progress",
        "reward/lateral_dig_cost",
        "reward/base_travel_cost",
        "reward/base_turn_cost",
        "reward/retained_work_setup_cost",
        "reward/retained_work_travel_cost",
        "reward/retained_work_turn_cost",
        "reward/trench",
        "reward/existence",
        *{f"curriculum/population/{label}" for label in (*FAMILIES, *BRANCH_DEPTHS)},
        ...
        "imitation/loss",
        *{f"imitation/{group}/{metric}"
          for group in ("foundation", "trench", "expert", "recovery")
          for metric in ("sample_fraction", "loss", "accuracy", "target_entropy")},
        "kickstart/kl",
        "kickstart/value_mse",
        "kickstart/kl_coef",
